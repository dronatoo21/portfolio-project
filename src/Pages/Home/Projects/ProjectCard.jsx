        ...
        <div className="text-white bg-[#31353b] rounded-xl">
            <div className="card glass md:h-[600px] lg:h-[570px]">
              ...
              <div className="card-body">
                ...
                {
                    description?.length > 150 ? <p className="font-normal">{description?.slice(0, 150)} <Link to={`/details/${_id}`} className="font-bold text-blue-200">Read more...</Link></p> : <p>{description}</p>
                }
